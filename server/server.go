...
var mapsCommands = map[string]interface{}{
	...
	"files": CfFiles,
	"bs": CfBindService,
	"bind-service": CfBindService,
	"unbind-service": CfUnBindService,
	"us": CfUnBindService,
	"env": CfEnv,
	"e": CfEnv,
	"m": CfMarketplace,
	"marketplace": CfMarketplace,
	"start": CfStart,
	"st": CfStart,
	"stop": CfStop,
	"sp": CfStop,
	...
	"rg": CfRestage,
	"restage": CfRestage,
	"delete-service": CfDeleteService,
	"ds": CfDeleteService,
	"domains": CfDomains,
	"create-user-provided-service": CfCreateUserProvidedService,
	"cups": CfCreateUserProvidedService,
	"map-route": CfMapRoute,
	"unmap-route": CfUnMapRoute,
	"help": CfHelp}
